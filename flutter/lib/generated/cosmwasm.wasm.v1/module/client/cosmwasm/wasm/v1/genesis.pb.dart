...
class GenesisState_GenMsgs extends $pb.GeneratedMessage {
  ...
  factory GenesisState_GenMsgs() => create();
  ...
  'Will be removed in next major version')
  GenesisState_GenMsgs copyWith(void Function(GenesisState_GenMsgs) updates) => super.copyWith((message) => updates(message as GenesisState_GenMsgs)); // ignore: deprecated_member_use
...
class Code extends $pb.GeneratedMessage {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Code copyWith(void Function(Code) updates) => super.copyWith((message) => updates(message as Code)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Contract extends $pb.GeneratedMessage {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Contract copyWith(void Function(Contract) updates) => super.copyWith((message) => updates(message as Contract)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
