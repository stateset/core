...
class MsgIBCSend extends $pb.GeneratedMessage {
  ...
  'Will be removed in next major version')
  MsgIBCSend copyWith(void Function(MsgIBCSend) updates) => super.copyWith((message) => updates(message as MsgIBCSend)); // ignore: deprecated_member_use
...
class MsgIBCCloseChannel extends $pb.GeneratedMessage {
  ...
  factory MsgIBCCloseChannel() => create();
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MsgIBCCloseChannel copyWith(void Function(MsgIBCCloseChannel) updates) => super.copyWith((message) => updates(message as MsgIBCCloseChannel)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
