...
class AccessTypeParam extends $pb.GeneratedMessage {
  ...
  factory AccessTypeParam() => create();
  ...
  'Will be removed in next major version')
  AccessTypeParam copyWith(void Function(AccessTypeParam) updates) => super.copyWith((message) => updates(message as AccessTypeParam)); // ignore: deprecated_member_use
...
class AccessConfig extends $pb.GeneratedMessage {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AccessConfig copyWith(void Function(AccessConfig) updates) => super.copyWith((message) => updates(message as AccessConfig)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CodeInfo extends $pb.GeneratedMessage {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CodeInfo copyWith(void Function(CodeInfo) updates) => super.copyWith((message) => updates(message as CodeInfo)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ContractInfo extends $pb.GeneratedMessage {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ContractInfo copyWith(void Function(ContractInfo) updates) => super.copyWith((message) => updates(message as ContractInfo)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ContractCodeHistoryEntry extends $pb.GeneratedMessage {
  ...
  factory ContractCodeHistoryEntry() => create();
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ContractCodeHistoryEntry copyWith(void Function(ContractCodeHistoryEntry) updates) => super.copyWith((message) => updates(message as ContractCodeHistoryEntry)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AbsoluteTxPosition extends $pb.GeneratedMessage {
  ...
  factory AbsoluteTxPosition() => create();
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AbsoluteTxPosition copyWith(void Function(AbsoluteTxPosition) updates) => super.copyWith((message) => updates(message as AbsoluteTxPosition)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
