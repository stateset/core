...
//  source: agreement/agreement.proto
//
// @dart = 2.3
...
class Agreement extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Agreement', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'stateset.core.agreement'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  Agreement copyWith(void Function(Agreement) updates) => super.copyWith((message) => updates(message as Agreement)); // ignore: deprecated_member_use
