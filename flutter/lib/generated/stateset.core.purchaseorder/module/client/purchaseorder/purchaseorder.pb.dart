...
class Purchaseorder extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Purchaseorder', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'stateset.core.purchaseorder'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  Purchaseorder copyWith(void Function(Purchaseorder) updates) => super.copyWith((message) => updates(message as Purchaseorder)); // ignore: deprecated_member_use
