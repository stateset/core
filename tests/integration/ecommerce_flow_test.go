...
func (s *ECommerceFlowTestSuite) setupTestAccounts() {
	...
	customerAcc := authtypes.NewBaseAccountWithAddress(s.customer)
	merchantAcc := authtypes.NewBaseAccountWithAddress(s.merchant)
	blockedAcc := authtypes.NewBaseAccountWithAddress(s.blockedUser)
