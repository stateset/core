...
const baseSentAgreement: object = { id: 0, did: "", chain: "", creator: "" };

export const SentAgreement = {
  encode(message: SentAgreement, writer: Writer = Writer.create()): Writer {
    if (message.id !== 0) {
  ...
  decode(input: Reader | Uint8Array, length?: number): SentAgreement {
    ...
    const message = { ...baseSentAgreement } as SentAgreement;
