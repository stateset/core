...
const baseTimedoutAgreement: object = {
  id: 0,
  did: "",
  chain: "",
  creator: "",
...
export const TimedoutAgreement = {
  encode(message: TimedoutAgreement, writer: Writer = Writer.create()): Writer {
    if (message.id !== 0) {
  ...
  decode(input: Reader | Uint8Array, length?: number): TimedoutAgreement {
    ...
    const message = { ...baseTimedoutAgreement } as TimedoutAgreement;
