...
const txClient = async (wallet: OfflineSigner, { addr: addr }: TxClientOptions = { addr: "http://localhost:26657" }) => {
  ...
  return {
    ...
    msgPayInvoice: (data: MsgPayInvoice): EncodeObject => ({ typeUrl: "/stateset.core.invoice.MsgPayInvoice", value: MsgPayInvoice.fromPartial( data ) }),
    ...
    msgVoidInvoice: (data: MsgVoidInvoice): EncodeObject => ({ typeUrl: "/stateset.core.invoice.MsgVoidInvoice", value: MsgVoidInvoice.fromPartial( data ) }),
