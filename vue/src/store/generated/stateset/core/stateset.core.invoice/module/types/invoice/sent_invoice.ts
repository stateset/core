...
const baseSentInvoice: object = { id: 0, did: "", chain: "", creator: "" };

export const SentInvoice = {
  encode(message: SentInvoice, writer: Writer = Writer.create()): Writer {
    if (message.id !== 0) {
  ...
  decode(input: Reader | Uint8Array, length?: number): SentInvoice {
    ...
    const message = { ...baseSentInvoice } as SentInvoice;
