...
const baseTimedoutInvoice: object = { id: 0, did: "", chain: "", creator: "" };

export const TimedoutInvoice = {
  encode(message: TimedoutInvoice, writer: Writer = Writer.create()): Writer {
    if (message.id !== 0) {
  ...
  decode(input: Reader | Uint8Array, length?: number): TimedoutInvoice {
    ...
    const message = { ...baseTimedoutInvoice } as TimedoutInvoice;
