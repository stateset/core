...
export declare const MsgPayInvoice: {
    encode(message: MsgPayInvoice, writer?: Writer): Writer;
...
export declare const MsgPayInvoiceResponse: {
    encode(_: MsgPayInvoiceResponse, writer?: Writer): Writer;
...
export declare const MsgVoidInvoice: {
    encode(message: MsgVoidInvoice, writer?: Writer): Writer;
...
export declare const MsgVoidInvoiceResponse: {
    encode(_: MsgVoidInvoiceResponse, writer?: Writer): Writer;
