...
const getDefaultState = () => {
    return {
        ...
        LoanAll: {},
        _Structure: {
            EventCreateLoan: getStructure(EventCreateLoan.fromPartial({})),
            EventLoanRequested: getStructure(EventLoanRequested.fromPartial({})),
            EventApproved: getStructure(EventApproved.fromPartial({})),
            EventRepaid: getStructure(EventRepaid.fromPartial({})),
            EventLiquidated: getStructure(EventLiquidated.fromPartial({})),
...
export default {
    ...
    actions: {
        init({ dispatch, rootGetters }) {
            console.log('Vuex module: stateset.core.loan initialized!');
