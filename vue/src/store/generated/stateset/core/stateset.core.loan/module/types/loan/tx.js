...
export class MsgClientImpl {
    ...
    LiquidateLoan(request) {
        ...
        const promise = this.rpc.request("stateset.core.loan.Msg", "LiquidateLoan", data);
        return promise.then((data) => MsgLiquidateLoanResponse.decode(new Reader(data)));
    }
    CancelLoan(request) {
        const data = MsgCancelLoan.encode(request).finish();
        const promise = this.rpc.request("stateset.core.loan.Msg", "CancelLoan", data);
