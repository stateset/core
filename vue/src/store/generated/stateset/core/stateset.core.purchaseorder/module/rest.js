...
/**
 * @title purchaseorder/events.proto
...
export class Api extends HttpClient {
    constructor() {
         ...
         */
        this.queryPurchaseorderAll = (query, params = {}) => this.request({
            path: `/stateset/core/purchaseorder/purchaseorder`,
            method: "GET",
            query: query,
            format: "json",
            ...params,
         ...
         */
        this.queryPurchaseorder = (id, params = {}) => this.request({
