...
const baseSentPurchaseorder: object = {
  id: 0,
  did: "",
  chain: "",
  creator: "",
...
export const SentPurchaseorder = {
  encode(message: SentPurchaseorder, writer: Writer = Writer.create()): Writer {
    if (message.id !== 0) {
  ...
  decode(input: Reader | Uint8Array, length?: number): SentPurchaseorder {
    ...
    const message = { ...baseSentPurchaseorder } as SentPurchaseorder;
