...
const baseTimedoutPurchaseorder: object = {
  id: 0,
  did: "",
  chain: "",
  creator: "",
...
export const TimedoutPurchaseorder = {
  encode(
  ...
  decode(input: Reader | Uint8Array, length?: number): TimedoutPurchaseorder {
    ...
    const message = { ...baseTimedoutPurchaseorder } as TimedoutPurchaseorder;
  ...
  fromPartial(
    object: DeepPartial<TimedoutPurchaseorder>
