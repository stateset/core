...
const baseQueryGetRefundRequest = { id: 0 };
export const QueryGetRefundRequest = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseQueryGetRefundRequest };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
const baseQueryGetRefundResponse = {};
export const QueryGetRefundResponse = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseQueryGetRefundResponse };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
const baseQueryAllRefundRequest = {};
export const QueryAllRefundRequest = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseQueryAllRefundRequest };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
const baseQueryAllRefundResponse = {};
export const QueryAllRefundResponse = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseQueryAllRefundResponse };
        message.Refund = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
...
export class QueryClientImpl {
    ...
    Params(request) {
        ...
        const promise = this.rpc.request("stateset.core.refund.Query", "Params", data);
        return promise.then((data) => QueryParamsResponse.decode(new Reader(data)));
    }
    Refund(request) {
        const data = QueryGetRefundRequest.encode(request).finish();
        const promise = this.rpc.request("stateset.core.refund.Query", "Refund", data);
        return promise.then((data) => QueryGetRefundResponse.decode(new Reader(data)));
    }
    RefundAll(request) {
        const data = QueryAllRefundRequest.encode(request).finish();
        const promise = this.rpc.request("stateset.core.refund.Query", "RefundAll", data);
        return promise.then((data) => QueryAllRefundResponse.decode(new Reader(data)));
    }
}
var globalThis = (() => {
