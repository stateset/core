...
func (*Agreement) Descriptor() ([]byte, []int) {
	return fileDescriptor_8002834873ec4fee, []int{0}
}
...
func (m *Agreement) GetDid() string {
	if m != nil {
		return m.Did
	}
	return ""
...
func (m *Agreement) GetUri() string {
	if m != nil {
		return m.Uri
	}
	return ""
...
func (m *Agreement) GetAmount() string {
	if m != nil {
		return m.Amount
	}
	return ""
...
func (m *Agreement) GetState() string {
	if m != nil {
		return m.State
	}
	return ""
...
func init() {
	proto.RegisterType((*Agreement)(nil), "stateset.core.agreement.Agreement")
}

func init() { proto.RegisterFile("agreement/agreement.proto", fileDescriptor_8002834873ec4fee) }

var fileDescriptor_8002834873ec4fee = []byte{
	// 214 bytes of a gzipped FileDescriptorProto
	,
	...
	0xe7, 0xe7, 0xea, 0xc3, 0xbc, 0xa0, 0x0f, 0xf2, 0x82, 0x7e, 0x05, 0xc2, 0x8f, 0xfa, 0x25, 0x95,
	0x05, 0xa9, 0xc5, 0x49, 0x6c, 0x60, 0xb7, 0x1b, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0xd2, 0x53,
	0x39, 0x03, 0x07, 0x01, 0x00, 0x00,
}
...
func (m *Agreement) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.State) > 0 {
		i -= len(m.State)
		copy(dAtA[i:], m.State)
		i = encodeVarintAgreement(dAtA, i, uint64(len(m.State)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.Amount) > 0 {
		...
		i = encodeVarintAgreement(dAtA, i, uint64(len(m.Amount)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Uri) > 0 {
		i -= len(m.Uri)
		copy(dAtA[i:], m.Uri)
		i = encodeVarintAgreement(dAtA, i, uint64(len(m.Uri)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Did) > 0 {
		i -= len(m.Did)
		copy(dAtA[i:], m.Did)
		i = encodeVarintAgreement(dAtA, i, uint64(len(m.Did)))
		i--
		dAtA[i] = 0x12
	}
	if m.Id != 0 {
