...
// source: stateset/epochs/genesis.proto
...
func init() {
	proto.RegisterType((*EpochInfo)(nil), "stateset.epochs.EpochInfo")
	proto.RegisterType((*GenesisState)(nil), "stateset.epochs.GenesisState")
}

func init() { proto.RegisterFile("stateset/epochs/genesis.proto", fileDescriptor_92af8154b2eb736d) }
