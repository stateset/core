...
func (s *KeeperTestSuite) SetupMsgSubmitQueryResponse() MsgSubmitQueryResponseTestCase {
	...
	// save the query to Stateset state, so it can be retrieved in the response
	query := types.Query{
		Id:           expectedId,
...
// As a first pass, to verify proof checking, we will use an example from Stateset integration testing
