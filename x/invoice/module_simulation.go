...
import (
	...
	invoicesimulation "github.com/stateset/core/x/invoice/simulation"
...
const (
	opWeightMsgCreateInvoice = "op_weight_msg_create_chain"
...
func (am AppModule) WeightedOperations(simState module.SimulationState) []simtypes.WeightedOperation {
	...
	simState.AppParams.GetOrGenerate(simState.Cdc, opWeightMsgCreateInvoice, &weightMsgCreateInvoice, nil,
		func(_ *rand.Rand) {
