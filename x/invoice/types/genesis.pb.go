...
func (*GenesisState) Descriptor() ([]byte, []int) {
	return fileDescriptor_32f04c33eab0a0ed, []int{0}
}
...
func (m *GenesisState) GetInvoiceCount() uint64 {
	if m != nil {
		return m.InvoiceCount
	}
	return 0
}
...
func (m *GenesisState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field InvoiceCount", wireType)
			}
			m.InvoiceCount = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
