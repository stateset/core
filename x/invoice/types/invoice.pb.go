...
type Invoice struct {
	...
	Amout string `protobuf:"bytes,4,opt,name=amout,proto3" json:"amout,omitempty"`
}
...
func (m *Invoice) GetAmout() string {
	if m != nil {
		return m.Amout
	}
	return ""
...
var fileDescriptor_b3e2b5ce0fcadd51 = []byte{
	...
	0xf4, 0xfc, 0xf4, 0x7c, 0xb0, 0x0a, 0x7d, 0x10, 0x0b, 0xa2, 0x58, 0x29, 0x98, 0x8b, 0xdd, 0x13,
	...
	0xc4, 0x04, 0x89, 0x94, 0x16, 0x65, 0x4a, 0x30, 0x43, 0x44, 0x4a, 0x8b, 0x32, 0x85, 0x44, 0xb8,
	0x58, 0x13, 0x73, 0xf3, 0x4b, 0x4b, 0x24, 0x58, 0xc0, 0x62, 0x10, 0x8e, 0x93, 0xd3, 0x89, 0x47,
	0x72, 0x8c, 0x17, 0x1e, 0xc9, 0x31, 0x3e, 0x78, 0x24, 0xc7, 0x38, 0xe1, 0xb1, 0x1c, 0xc3, 0x85,
	0xc7, 0x72, 0x0c, 0x37, 0x1e, 0xcb, 0x31, 0x44, 0x69, 0xa4, 0x67, 0x96, 0x64, 0x94, 0x26, 0xe9,
	0x25, 0xe7, 0xe7, 0xea, 0xc3, 0x9c, 0xa9, 0x0f, 0x72, 0xa6, 0x7e, 0x05, 0xcc, 0x17, 0xfa, 0x25,
	0x95, 0x05, 0xa9, 0xc5, 0x49, 0x6c, 0x60, 0xf7, 0x19, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0x7c,
	0xdf, 0xac, 0x0c, 0xe5, 0x00, 0x00, 0x00,
}
...
func (m *Invoice) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Amout) > 0 {
		i -= len(m.Amout)
		copy(dAtA[i:], m.Amout)
		i = encodeVarintInvoice(dAtA, i, uint64(len(m.Amout)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Uri) > 0 {
...
func (m *Invoice) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Amout", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Amout = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
