...
func (*GenesisState) Descriptor() ([]byte, []int) {
	return fileDescriptor_142be3b877c419d0, []int{0}
}
...
func (m *GenesisState) GetPurchaseorderList() []Purchaseorder {
	if m != nil {
		return m.PurchaseorderList
	}
	return nil
}

func (m *GenesisState) GetPurchaseorderCount() uint64 {
	if m != nil {
		return m.PurchaseorderCount
	}
	return 0
}
...
func (m *GenesisState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.PurchaseorderList) > 0 {
		for iNdEx := len(m.PurchaseorderList) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.PurchaseorderList[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *GenesisState) Size() (n int) {
	...
	_ = l
	if len(m.PurchaseorderList) > 0 {
		for _, e := range m.PurchaseorderList {
			l = e.Size()
...
func (m *GenesisState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PurchaseorderList", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PurchaseorderList = append(m.PurchaseorderList, Purchaseorder{})
			if err := m.PurchaseorderList[len(m.PurchaseorderList)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PurchaseorderCount", wireType)
			}
			m.PurchaseorderCount = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowGenesis
				}
