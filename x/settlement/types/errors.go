...
var (
	...
	ErrInvalidSignature           = errorsmod.Register(ModuleName, 30, "invalid signature")
	ErrSignatureVerificationFailed = errorsmod.Register(ModuleName, 31, "signature verification failed")
