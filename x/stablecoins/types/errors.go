...
var (
	...
	ErrInvalidDenom              = sdkerrors.Register(ModuleName, 1301, "invalid denomination")
	ErrInvalidTerm               = sdkerrors.Register(ModuleName, 1302, "invalid term")
	ErrInvalidRequest            = sdkerrors.Register(ModuleName, 1303, "invalid request")
	ErrInvalidRate               = sdkerrors.Register(ModuleName, 1304, "invalid rate")
	ErrInvalidRatio              = sdkerrors.Register(ModuleName, 1305, "invalid ratio")
	ErrInvalidLoan               = sdkerrors.Register(ModuleName, 1306, "invalid loan")
	ErrInvalidPool               = sdkerrors.Register(ModuleName, 1307, "invalid pool")
	ErrLoanNotFound              = sdkerrors.Register(ModuleName, 1308, "loan not found")
	ErrPoolNotFound              = sdkerrors.Register(ModuleName, 1309, "pool not found")
	ErrInsufficientPoolFunds     = sdkerrors.Register(ModuleName, 1310, "insufficient pool funds")
	ErrLoanAlreadyDisbursed      = sdkerrors.Register(ModuleName, 1311, "loan already disbursed")
	ErrCreditLineNotFound        = sdkerrors.Register(ModuleName, 1312, "credit line not found")
	ErrCreditLineExceeded        = sdkerrors.Register(ModuleName, 1313, "credit line exceeded")
	ErrCreditLineExpired         = sdkerrors.Register(ModuleName, 1314, "credit line expired")
)